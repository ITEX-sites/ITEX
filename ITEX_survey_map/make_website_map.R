...
itex_locs=read.csv('./ITEX_survey_map/ITEX research site survey 2019 (Responses) - Form Responses.csv')[,c(1:201)]
nm=read_excel('./ITEX_survey_map/rename.xlsx', col_names=FALSE)
